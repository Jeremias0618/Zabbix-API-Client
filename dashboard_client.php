...
function getZabbixData() {
    ...
    try {
        ...
        // 3) Obtener filtros de tags desde configuración
        $tagFiltersConfig = getTagFilters();
        $tagFilters = array_merge($tagFiltersConfig['equipo_alarmado'], $tagFiltersConfig['problemas_potencia']);
